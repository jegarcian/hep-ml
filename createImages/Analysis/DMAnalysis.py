...
#      import matplotlib.pyplot as plt
      ...
      if useROOT :
        ...
        # Represent Jets 
        for jet in goodJets :
            scalePt = 1.5*self.hist_jetspt.GetXaxis().FindBin(jet.pt())
            if VERBOSE :
        ...
        scalePt = 1.5*self.hist_etmiss.GetXaxis().FindBin(etmiss.et())
        ...
        # Represent Leptons 
        scalePt = 1.5*self.hist_leptpt.GetXaxis().FindBin(leadlepton.pt())
